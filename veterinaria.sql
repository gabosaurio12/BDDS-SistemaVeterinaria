...
--
-- Host: localhost    Database: sistema_veterinaria
-- ------------------------------------------------------
...
CREATE TABLE `direccion_veterinario` (
  ...
  PRIMARY KEY (`numeroDeCasa`),
  KEY `cedula` (`cedula`),
  CONSTRAINT `direccion_veterinario_ibfk_1` FOREIGN KEY (`cedula`) REFERENCES `veterinario` (`Cedula`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cita` (
  ...
  KEY `Cedula` (`Cedula`),
  CONSTRAINT `cita_ibfk_1` FOREIGN KEY (`numeroDeINE`) REFERENCES `secretaria` (`numeroDeINE`) ON UPDATE CASCADE,
  CONSTRAINT `cita_ibfk_2` FOREIGN KEY (`idMascota`) REFERENCES `mascota` (`idMascota`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `cita_ibfk_3` FOREIGN KEY (`Cedula`) REFERENCES `veterinario` (`Cedula`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fechacita_cita` (
  ...
  PRIMARY KEY (`idCita`),
  CONSTRAINT `fechacita_cita_ibfk_1` FOREIGN KEY (`idCita`) REFERENCES `cita` (`idCita`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-05-04 11:26:52
